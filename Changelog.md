...
## [v3.8.0] MODDER TOOLKIT EXPANSION - UNRELEASED (Work-In-Progress)

*Six purely additive API surfaces, all built to support Cosmic War's v4.0.0 War Overhaul Update, all reusable by any Cosmic mod. No existing exported behavior changed or removed.*
