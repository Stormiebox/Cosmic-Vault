meta =
{
    ...
    dependencies = {
        ...
        { id = "2944669973", exact = "*.*", incompatible = true },
        { id = "2943435828", exact = "*.*", incompatible = true },
        { id = "2941426377", exact = "*.*", incompatible = true },
        { id = "3319681872", exact = "*.*", incompatible = true },
        { id = "1722261398", exact = "*.*", incompatible = true },
        { id = "2018219527", exact = "*.*", incompatible = true },
        { id = "2926607929", exact = "*.*", incompatible = true },
        { id = "2613755961", exact = "*.*", incompatible = true },
        { id = "2923179923", exact = "*.*", incompatible = true },
